...
// either white (#FFFFFF) or near-black (#262729) text.
...
export function readableTextColor(bg) {
  return contrastRatio(bg, "#FFFFFF") >= contrastRatio(bg, "#262729")
    ? "#FFFFFF"
    : "#262729";
}
...
// Convert any color into a bright, playful pastel that pairs with #262729 text.
...
// (evenly-stepped hues at S85 / ~L65). Every color tested ≥ 4.5:1 vs #262729;
