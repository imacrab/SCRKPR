                  ...
                  <button
                    ...
                    style={{
                      ...
                      <span className="flex flex-col">
                        <span className="text-foreground leading-tight text-xl [font-family:'Geist',_sans-serif] font-semibold">{label}</span>
                        <span className="text-muted-foreground leading-tight mt-0.5 text-base">{sub}</span>
                      </span>
                    </button>);
