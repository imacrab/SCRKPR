    ...
    <div className="flex flex-col rounded-xl overflow-hidden">
      ...
      <div
        ...
        <div
          ...
          aria-hidden="true">
            <FluentEmoji emoji={player.emoji} size={72} />
          </div>
        }
        ...
        <div className="relative z-10 flex items-center justify-between w-full gap-1">
          ...
          <motion.button
            ...
            style={{ width: 44, height: 44, borderRadius: 9999, backgroundColor: buttonBg, color: textColor, backdropFilter: "blur(2.5px)", WebkitBackdropFilter: "blur(2.5px)" }}
