...
export default function BottomNavigationBar({ hidden = false }) {
  ...
  return (
    ...
    >
    <div className="flex flex-1 border border-border rounded-full rounded-bl-sm rounded-br-sm overflow-hidden" style={{ backgroundColor: "hsl(var(--card) / 0.8)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)", boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)" }}>
