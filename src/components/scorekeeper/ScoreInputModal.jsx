      ...
      {isOpen && player && (
        <>
          ...
          <motion.div
            ...
            style={{ backgroundColor: "hsl(var(--card) / 0.8)", backdropFilter: "blur(1px)", WebkitBackdropFilter: "blur(1px)", bottom: "8px", left: "8px", right: "8px", paddingBottom: "env(safe-area-inset-bottom)" }}
          >
            <div className="px-5 pt-5 pb-8">
              ...
              <div className="flex gap-3 mt-4">
                ...
                >
                  <X size={24} strokeWidth={2} className="mr-1.5" />
                  Cancel
                </Button>
                <Button
                ...
                >
                  <Check size={24} strokeWidth={2} className="mr-1.5" />
