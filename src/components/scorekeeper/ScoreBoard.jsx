      ...
      <div className="flex-1 px-2 pb-2 overflow-hidden w-full relative">
        ...
        <div
          ...
          <button
            ...
            className="relative w-full flex items-center gap-2 h-12 px-6 rounded-xl bg-white hover:bg-white/90 text-background font-semibold text-sm shadow-lg transition-colors overflow-hidden">
